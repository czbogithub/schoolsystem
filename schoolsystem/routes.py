...
from schoolsystem.forms import NameForm, LoginForm, QueryForm, DeleteForm, EditForm, UploadForm, EditTeacher
from schoolsystem.models import Note, Note_yet, db, Admin
from flask_login import login_user, current_user, login_required, logout_user
from datetime import date
# from sqlalchemy import or_, and_
from schoolsystem.fun import excel, random_filename
import os
import string
